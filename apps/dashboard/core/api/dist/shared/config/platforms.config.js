...
function getPlatformSpec(platform) {
    return exports.platformSpecs[platform] || null;
}
function getAllPlatforms() {
    return Object.values(exports.platformSpecs);
}
exports.default = exports.platformSpecs;
