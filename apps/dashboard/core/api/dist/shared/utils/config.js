...
exports.config = {
    ...
    // Storage
    storage: {
        sessionPath: process.env.SESSION_STORAGE_PATH || path_1.default.join(process.cwd(), 'data/sessions'),
        screenshotPath: process.env.SCREENSHOT_PATH || path_1.default.join(process.cwd(), 'data/screenshots'),
    },
    // Notifications
    notifications: {
        feishu: {
