...
router.get('/', async (req, res) => {
    try {
        ...
        logger_1.default.error('[Tasks] Query error:', error.message);
        res.status(500).json({
            success: false,
...
router.patch('/:id', async (req, res) => {
    try {
        ...
        logger_1.default.error('[Tasks] Update error:', error.message);
        res.status(500).json({
            success: false,
...
router.post('/', async (req, res) => {
    try {
        ...
        logger_1.default.error('[Tasks] Create error:', error.message);
        res.status(500).json({
            success: false,
