...
export type EventType = 'run.created' | 'run.started' | 'tool.started' | 'tool.finished' | 'subagent.spawned' | 'subagent.finished' | 'log' | 'run.failed' | 'run.completed' | 'user.message' | 'assistant.message';
