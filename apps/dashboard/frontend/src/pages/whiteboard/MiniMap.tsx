...
export default function MiniMap({ nodes, edges, viewBox, canvasSize, onPanTo }: MiniMapProps) {
  ...
  return (
    <div className="absolute bottom-16 right-4 w-[180px] h-[120px] bg-slate-800/80 border border-slate-600 rounded-lg overflow-hidden shadow-lg backdrop-blur-sm">
      <svg
        ref={svgRef}
        width="100%"
        height="100%"
