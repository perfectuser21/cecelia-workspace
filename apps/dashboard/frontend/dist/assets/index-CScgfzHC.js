const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ContentPublish-DHvt6OtK.js","assets/publish.api-D33NbTu_.js","assets/client-DyfwnZmM.js","assets/index-B9ygI19o.js","assets/PublishStats-V0xEZzVX.js","assets/generateCategoricalChart-BNMN1HnK.js","assets/tiny-invariant-BaFNuDhB.js","assets/LoginPage-CBtGhAvx.js","assets/AiEmployeesPage-C05cFUYM.js","assets/DynamicIcon-D9gsLlU9.js","assets/ai-employees.api-DCgx3ksA.js","assets/AiEmployeeDetailPage-7SHWb312.js","assets/AiAbilityDetailPage-BawK3ffC.js","assets/AccountsList-C2nfZ_Ib.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(A,b){var V=A.length;A.push(b);e:for(;0<V;){var G=V-1>>>1,Y=A[G];if(0<o(Y,b))A[G]=b,A[V]=Y,V=G;else break e}}function n(A){return A.length===0?null:A[0]}function r(A){if(A.length===0)return null;var b=A[0],V=A.pop();if(V!==b){A[0]=V;e:for(var G=0,Y=A.length,xn=Y>>>1;G<xn;){var q1=2*(G+1)-1,kM=A[q1],P1=q1+1,wn=A[P1];if(0>o(kM,V))P1<Y&&0>o(wn,kM)?(A[G]=wn,A[P1]=V,G=P1):(A[G]=kM,A[q1]=V,G=q1);else if(P1<Y&&0>o(wn,V))A[G]=wn,A[P1]=V,G=P1;else break e}}return b}function o(A,b){var V=A.sortIndex-b.sortIndex;return V!==0?V:A.id-b.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var c=Date,l=c.now();e.unstable_now=function(){return c.now()-l}}var d=[],h=[],p=1,y=null,u=3,x=!1,v=!1,w=!1,C=typeof setTimeout=="function"?setTimeout:null,k=typeof clearTimeout=="function"?clearTimeout:null,s=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(A){for(var b=n(h);b!==null;){if(b.callback===null)r(h);else if(b.startTime<=A)r(h),b.sortIndex=b.expirationTime,t(d,b);else break;b=n(h)}}function M(A){if(w=!1,f(A),!v)if(n(d)!==null)v=!0,uM(I);else{var b=n(h);b!==null&&pM(M,b.startTime-A)}}function I(A,b){v=!1,w&&(w=!1,k(z),z=-1),x=!0;var V=u;try{for(f(b),y=n(d);y!==null&&(!(y.expirationTime>b)||A&&!B());){var G=y.callback;if(typeof G=="function"){y.callback=null,u=y.priorityLevel;var Y=G(y.expirationTime<=b);b=e.unstable_now(),typeof Y=="function"?y.callback=Y:y===n(d)&&r(d),f(b)}else r(d);y=n(d)}if(y!==null)var xn=!0;else{var q1=n(h);q1!==null&&pM(M,q1.startTime-b),xn=!1}return xn}finally{y=null,u=V,x=!1}}var q=!1,S=null,z=-1,P=5,H=-1;function B(){return!(e.unstable_now()-H<P)}function oe(){if(S!==null){var A=e.unstable_now();H=A;var b=!0;try{b=S(!0,A)}finally{b?He():(q=!1,S=null)}}else q=!1}var He;if(typeof s=="function")He=function(){s(oe)};else if(typeof MessageChannel<"u"){var Zx=new MessageChannel,NS=Zx.port2;Zx.port1.onmessage=oe,He=function(){NS.postMessage(null)}}else He=function(){C(oe,0)};function uM(A){S=A,q||(q=!0,He())}function pM(A,b){z=C(function(){A(e.unstable_now())},b)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(A){A.callback=null},e.unstable_continueExecution=function(){v||x||(v=!0,uM(I))},e.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<A?Math.floor(1e3/A):5},e.unstable_getCurrentPriorityLevel=function(){return u},e.unstable_getFirstCallbackNode=function(){return n(d)},e.unstable_next=function(A){switch(u){case 1:case 2:case 3:var b=3;break;default:b=u}var V=u;u=b;try{return A()}finally{u=V}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(A,b){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var V=u;u=A;try{return b()}finally{u=V}},e.unstable_scheduleCallback=function(A,b,V){var G=e.unstable_now();switch(typeof V=="object"&&V!==null?(V=V.delay,V=typeof V=="number"&&0<V?G+V:G):V=G,A){case 1:var Y=-1;break;case 2:Y=250;break;case 5:Y=1073741823;break;case 4:Y=1e4;break;default:Y=5e3}return Y=V+Y,A={id:p++,callback:b,priorityLevel:A,startTime:V,expirationTime:Y,sortIndex:-1},V>G?(A.sortIndex=V,t(h,A),n(d)===null&&A===n(h)&&(w?(k(z),z=-1):w=!0,pM(M,V-G))):(A.sortIndex=Y,t(d,A),v||x||(v=!0,uM(I))),A},e.unstable_shouldYield=B,e.unstable_wrapCallback=function(A){var b=u;return function(){var V=u;u=b;try{return A.apply(this,arguments)}finally{u=V}}}})(AL);jL.exports=AL;var uI=jL.exports;/**
 * @license React
