...
import { Database, RefreshCw, Play, CheckCircle2, XCircle, Clock, Loader2 } from 'lucide-react';
    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6 hover:shadow-lg transition-shadow">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          <div
            className={`w-12 h-12 rounded-xl ${platformStyle.bgColor} flex items-center justify-center`}
          >
        ...
        {/* 状态标签 */}
        <div
          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium ${statusConfig.bgColor} ${statusConfig.color}`}
        >
