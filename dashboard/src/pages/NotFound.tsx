...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-l from-[#01C7D2]/20 to-[#3C8CFD]/20 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto page-fade-in">
        ...
        {/* 提示文案 */}
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">页面走丢了</h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          >
            {/* 悬停光泽效果 */}
            <div
              className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform -translate-x-full group-hover:translate-x-full"
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          <p className="text-sm text-blue-200/60">如果您认为这是一个错误，请联系管理员</p>
        </div>
      </div>
