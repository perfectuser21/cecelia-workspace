...
import type { CoreConfig } from '../../../features/types';
...
// Re-export CoreConfig from features (includes allRoutes)
...
export async function loadCoreConfig(): Promise<CoreConfig | null> {
  if (cachedCoreConfig) return cachedCoreConfig;

  try {
    const { buildCoreConfig } = await import('../../../features');
...
export function InstanceProvider({ children }: { children: ReactNode }) {
  ...
  // 应用主题到 CSS 变量
  const applyTheme = React.useCallback((theme: ThemeConfig, instance: string) => {
