...
- [ ] validatePrd() 对缺少"成功标准"的 PRD 返回 { valid: false } 并包含具体错误
      Test: apps/core/src/brain/__tests__/templates.test.js
- [ ] validatePrd() 检测模糊词（"优化"、"改进"）并降低评分
      Test: apps/core/src/brain/__tests__/templates.test.js

### 功能验收 - validateTrd
- [ ] validateTrd() 对完整 TRD 返回 { valid: true }
      Test: apps/core/src/brain/__tests__/templates.test.js
- [ ] validateTrd() 对缺少必需 section 的 TRD 返回 { valid: false }
      Test: apps/core/src/brain/__tests__/templates.test.js

### 功能验收 - API 端点
- [ ] POST /api/brain/validate/prd 返回 200 + { valid, score, errors } JSON
      Test: apps/core/src/brain/__tests__/templates.test.js
- [ ] POST /api/brain/validate/trd 返回 200 + { valid, errors } JSON
      Test: apps/core/src/brain/__tests__/templates.test.js

### 功能验收 - Decomposer 统一调用
- [ ] Decomposer generatePRD() 调用 renderPrd() 生成标准格式
      Test: apps/core/src/brain/__tests__/templates.test.js
